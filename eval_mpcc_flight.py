...
def evaluate_flight(
    ...
    config = TASK_CONFIG["flight"]
    keys = config["keys"]
    print(f"Task: FLIGHT PLANNING")
    ...
    print(f"=== MPCC Evaluation (Flight) ===")
...
def main():
    ...
    parser.add_argument("--parquet", type=str, required=True, help="Path to flight_plan_*.parquet")
